...
name = 'dream_10_4_correct'; %modify this to NAME of dataset
...
resname = strcat('../data/result_',name,'_jug'); %set appropriate destn result mat name here
addpath('../helpers');
...
for k=2:6
    ...
    ige_out{k} = ige_analysis_jug(grn,exp,metricmat,strcat(figname,method(k))); %comment 'fig' if you wish to not save plots to an apt folder
end
