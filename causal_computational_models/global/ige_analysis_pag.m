function [ out ] = ige_analysis_pag( grn, exp, metric, figname )
...
size(metric)
[adj_found, all_adjs, all_errors] = pageranker(metric); %can also append '_multiattribute'
adj_found
...
if nargin>=4
    ...
    title('ROC plot');
    print(strcat(figname,'ROCplotPAG'),'-dpng');
    figure(2); clf;
    hold;
    ...
    print(strcat(figname,'ScatterPAG'),'-dpng');
end
end
