function [ out ] = ige_analysis_jug( grn, exp, metric, figname )
...
size(metric)
[adj_found, all_adjs, all_errors] = juggler(metric); %can also append '_multiattribute'
adj_found
...
if nargin>=4
    ...
    title('ROC plot');
    print(strcat(figname,'ROCplotJUG'),'-dpng');
    figure(2); clf;
    hold;
    ...
    print(strcat(figname,'ScatterJUG'),'-dpng');
end
end
